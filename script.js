...
const resumeData = {
  ...
  experience: [
    ...
    },
    {
      ...
      description:
        "Successfully developed backend and mobile applications for various projects, including a social network, a neobank (https://sapheer.co), a video conferencing app, and secured a GraphQL API managing multiple IoT microservices. Demonstrated expertise in technologies such as NodeJS, ReactNative, and AWS.",
      technologies: [
        "NodeJS",
        "ReactNative",
        "GraphQL",
    ...
    },
    {
      ...
      company:
        "OCSIF (Organisme de Coordination et de Suivi des Investissements et de leur Financements)",
      location: "Madagascar",
      period: "Aug 2018 - May 2019",
      description:
        "Developed a comprehensive data consolidation tool for monitoring investments at OCSIF. This tool significantly enhanced the tracking of government projects in Madagascar, utilizing technologies such as Java, Hibernate, Spring, MySQL, Leaflet, and jQuery to optimize performance and usability.",
      technologies: [
        "Java",
        "Hibernate",
        "Spring",
    ...
    },
    {
      ...
      description:
        "Successfully developed the Performance Indicator Management System (PIMS) application, which effectively tracks progress towards the outcomes of USAID programs in Madagascar. This innovative tool utilizes PHP and CodeIgniter to manage data efficiently, ensuring that all stakeholders have access to critical performance insights.",
      technologies: [
        "PHP",
        "CodeIgniter",
        "SQL Server",
    ...
    },
    {
      ...
      description:
        "Developed a comprehensive lifecycle management tool for application roles within the Human Resource Management platform (E-RH) at Orange Madagascar, effectively enhancing operational efficiency and user experience through innovative use of technology such as C#, .Net, and MySQL.",
  ...
  education: [
    ...
    {
      title:
        "Innovative Technology Specialist in Mobiquity and Big Data Integration",
      institution: "Université de Nice Sophia Antipolis (UNS)",
      period: "Oct 2017 - Sep 2019",
      description:
        "Education focused on advanced database concepts and infrastructures, mobile information systems, and application development using Kotlin, JAVA, and React. Specialized in project management and Agile design methodologies to integrate ERP systems and enhance business processes through big data and machine learning applications.",
      technologies: [
        "Kotlin",
        "JAVA",
        "Node.js",
    ...
    },
    {
      ...
      description:
        "Achieved 2nd place in the inaugural Inter-University Hackathon organized by TechZara in 2018, demonstrating strong skills in software development and teamwork. This experience enhanced technical proficiency in C#, PHP, JAVA, and Angular, while fostering collaboration in a competitive environment.",
      technologies: [
...
function populateExperience() {
  resumeData.experience.forEach((exp, index) => {
    ...
    expElement.className =
      "bg-white p-6 rounded-lg shadow-md border-l-4 border-primary-700 animate-slide-up";
    ...
    expElement.innerHTML = `
            <div class="flex flex-col md:flex-row md:justify-between md:items-start mb-4">
                ...
                <span class="bg-primary-100 text-primary-800 px-3 py-1 rounded-full text-sm font-medium mt-2 md:mt-0">${
                  exp.period
                }</span>
            </div>
...
function populateEducation() {
  resumeData.education.forEach((edu, index) => {
    ...
    eduElement.className =
      "bg-white p-6 rounded-lg shadow-md border-l-4 border-secondary-600 animate-slide-up";
    ...
    eduElement.innerHTML = `
            <div class="flex flex-col md:flex-row md:justify-between md:items-start mb-4">
                ...
                <span class="bg-secondary-100 text-secondary-800 px-3 py-1 rounded-full text-sm font-medium mt-2 md:mt-0">${
                  edu.period
                }</span>
            </div>
...
function populateSkills() {
  ...
  resumeData.skills.technicalSkills.forEach((skill) => {
    ...
    skillElement.className =
      "bg-primary-100 text-primary-800 px-3 py-1 rounded-full text-sm font-medium";
...
window.addEventListener("load", async () => {
  ...
  if (heroTitle) {
    const originalText = heroTitle.textContent.trim(); // Use trim() to remove potential whitespace
    heroTitle.textContent = ""; // Clear content before typing
    await typeWriter(heroTitle, originalText, 50);

    // Remove any existing blinking cursor before adding a new one
    const existingCursor = heroTitle.querySelector('.blinking-cursor');
    if (existingCursor) {
      existingCursor.remove();
    }

    heroTitle.innerHTML += '<span class="blinking-cursor">_</span>';
  }
});
...
function createScrollProgress() {
  ...
  progressBar.className =
    "fixed top-0 left-0 w-full h-1 bg-primary-700 z-50 transform origin-left scale-x-0 transition-transform duration-150";
